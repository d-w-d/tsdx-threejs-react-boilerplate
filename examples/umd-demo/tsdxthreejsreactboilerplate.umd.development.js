(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('three'), require('three/examples/jsm/controls/OrbitControls'), require('three/examples/jsm/controls/TrackballControls'), require('three/examples/jsm/loaders/OBJLoader2'), require('three/examples/jsm/loaders/MTLLoader'), require('three/examples/jsm/loaders/obj2/bridge/MtlObjBridge.js'), require('three/examples/jsm/loaders/FBXLoader')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'three', 'three/examples/jsm/controls/OrbitControls', 'three/examples/jsm/controls/TrackballControls', 'three/examples/jsm/loaders/OBJLoader2', 'three/examples/jsm/loaders/MTLLoader', 'three/examples/jsm/loaders/obj2/bridge/MtlObjBridge.js', 'three/examples/jsm/loaders/FBXLoader'], factory) :
  (global = global || self, factory(global.TsdxThreeJsReactBoilerplate = {}, global.React, global.THREE, global.OrbitControls, global.TrackballControls, global.OBJLoader2, global.MTLLoader, global.MtlObjBridge_js, global.FBXLoader$1));
}(this, (function (exports, React, THREE, OrbitControls, TrackballControls, OBJLoader2, MTLLoader, MtlObjBridge_js, FBXLoader$1) { 'use strict';
  ...
  /**
   * This abstract class is inherited by the SceneManager instance.
   ...
   * need to implement the specifics of your scene is in the implementation of your
  ...
  var AbstractSceneManager = /*#__PURE__*/function () {
        ...
        return runtime_1.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 36:
                _context2.next = 38;
                return Promise.all(this.sceneEntities.map( /*#__PURE__*/function () {
    ...
    _proto.update = function update() {
      ...
      this.sceneEntities.forEach(function (el) {
  ...
  var SceneManager = /*#__PURE__*/function (_AbstractSceneManager) {
    ...
    function SceneManager(containerId) {
      ...
      [new DemoObjLoader(), new MiscHelpers(), new SimpleLight()].forEach(function (el) {
        return _this.sceneEntities.push(el);
  ...
  function initFpsStats() {
    ...
    script.onload = function () {
      return console.log('Stats script loaded');
    };
  ...
  function startFpsStats() {
    ...
    stats.dom.style.right = '0px'; // console.log('>>', stats.dom);
  ...
  function stopFpsStats() {
    ...
    var element = document.getElementById(fpsStatsId);
    var parent = element == null ? void 0 : element.parentNode;
    if (!!element && !!parent) parent.removeChild(element);
  }

  function setIsFpsStatsShown(isShown) {
    isShown ? startFpsStats() : stopFpsStats();
  }

  var count = 0;
  var getSimpleUID = function getSimpleUID() {
    count++;
  ...
  var AppEntry = function AppEntry(props) {
    ...
    var _defaultProps$props = _extends({}, defaultProps, props),
        backgroundColor = _defaultProps$props.backgroundColor,
        width = _defaultProps$props.width,
        height = _defaultProps$props.height;

    var uid = React.useRef(getSimpleUID());
    var containerId = 'container-id-' + uid.current;
    var windowSize = useWindowSize();

    var _useState = React.useState(new SceneManager(containerId)),
        demoSceneManager = _useState[0];

    var _useState2 = React.useState(false),
        isHelpersShown = _useState2[0],
        setIsHelpersShown = _useState2[1]; // On First Render Events
    ...
    return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
      ...
      onClick: function onClick() {
        return setIsHelpersShown(function (prev) {
          return !prev;
        });
      }
    }, "Toggle Helpers"), React__default.createElement("button", {
      style: {
        position: 'absolute',
        top: 0,
        left: '50%',
      ...
      onClick: function onClick() {
        return demoSceneManager.toggleRotation();
      }
  ...
  var TsdxThreeJsReactBoilerplate = function TsdxThreeJsReactBoilerplate(props) {
    return React.createElement(AppEntry, Object.assign({}, props));
  };
  /**
  ...
  var Init = function Init(id, props) {
    ...
    // @ts-ignore
    ReactDOM.render(React.createElement(TsdxThreeJsReactBoilerplate, Object.assign({}, props)), document.getElementById(id));
  };

  exports.Init = Init;
  exports.TsdxThreeJsReactBoilerplate = TsdxThreeJsReactBoilerplate;

  Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=tsdxthreejsreactboilerplate.umd.development.js.map
